...
var mSleepTimePeriod = 600 * 1000 * 5;
//test
...
function mixCoor2(mac, newPos, status)
{
    ...
    ansPos.floorId = newPos.floorId;
    ansPos.coordinate = {};
    ansPos.coordinate.x = x.toFixed(2);
    ansPos.coordinate.y = y.toFixed(2);
    return ansPos;
}
...
var sBeaconLength = 1;  //beacons ary length 至少高於此數量，否則捨棄
