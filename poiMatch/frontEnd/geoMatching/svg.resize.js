...
;(function () {
    ...
    ResizeHandler.prototype.resize = function (event) {
        ...
        switch (event.type) {
            ...
            case 'rot':
                ...
                this.calc = function (diffX, diffY) {
                    ...
                    .rotate(
                        this.parameters.rotation + angle - angle % this.options.snapToAngle, 
                        this.parameters.box.cx, 
                        this.parameters.box.cy
                    );

                    // this.el.anti_rot = this.parameters.rotation + angle - angle % this.options.snapToAngle;
        ...
        SVG.on(window, 'mouseup.resize', function () {
            (window.updateCustomWidthHeightInput|| function(){})();//add by zhaop
            _this.done();
